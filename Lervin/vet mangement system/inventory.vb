...
Public Class inventory
    ...
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        Dim service_id As String = txtSearch.Text
        Dim query As String
        ...
        Try
            ...
            query = "SELECT * FROM service_items WHERE service_id = '" & service_id & "'"
            ...
            If dt.Rows.Count > 0 Then
                ...
                txtItemID.Text = dt.Rows(0).Item("service_id").ToString()
                txtItemName.Text = dt.Rows(0).Item("service_name").ToString()
                txtDescription.Text = dt.Rows(0).Item("service_description").ToString()
                txtPrice.Text = dt.Rows(0).Item("price").ToString()
                txtStock.Text = dt.Rows(0).Item("stocked").ToString()
                txtCreationDate.Text = dt.Rows(0).Item("created_at").ToString()
                txtLastUpdated.Text = dt.Rows(0).Item("updated_at").ToString()
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnActive.Click
    ...
    Private Sub btnVoid_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnVoid.Click
